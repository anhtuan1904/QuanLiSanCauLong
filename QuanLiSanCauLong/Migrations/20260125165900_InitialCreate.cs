        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceSlots_Courts_CourtId",
                        column: x => x.CourtId,
                        principalTable: "Courts",
                        principalColumn: "CourtId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PriceSlots_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "FacilityId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourtPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CourtId");
                    table.ForeignKey(
                        name: "FK_Bookings_Users_CheckInBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTransactions_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "FacilityId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "FacilityId");
                    table.ForeignKey(
                        name: "FK_Inventories_Facilities_FacilityId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_FacilityId",
                table: "Inventories",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_FacilityId1",
                table: "Inventories",
                column: "FacilityId1");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_ProductId_FacilityId",
                table: "Inventories",
                columns: new[] { "ProductId", "FacilityId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceSlots_CourtId",
                table: "PriceSlots",
                column: "CourtId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceSlots_FacilityId",
                table: "PriceSlots",
                column: "FacilityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactionDetails_TransactionId",
                table: "StockTransactionDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_FacilityId",
                table: "StockTransactions",
                column: "FacilityId");
